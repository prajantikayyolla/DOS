...
numNodes <- string(fsi.CommandLineArgs.GetValue 1) |> int
numRequest <- string(fsi.CommandLineArgs.GetValue 2) |> int
...
printfn "Average Number of Hops: %A" (float requestHops / float (requestCompleted))
